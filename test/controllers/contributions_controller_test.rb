...
class ContributionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post contributions_url, params: { contribution: { belongs_to: @contribution.belongs_to, description: @contribution.description, name: @contribution.name, status: @contribution.status, type: @contribution.type } }
    end
  ...
  test "should update contribution" do
    patch contribution_url(@contribution), params: { contribution: { belongs_to: @contribution.belongs_to, description: @contribution.description, name: @contribution.name, status: @contribution.status, type: @contribution.type } }
